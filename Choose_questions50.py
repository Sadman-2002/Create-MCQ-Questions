...
def generate_mcqs_with_ai(text, num_questions=10):
    ...
    try:
        # Limit text length based on number of questions
        max_chars = min(15000, num_questions * 1000)
        if len(text) > max_chars:
            text = text[:max_chars]
        
        prompt = f"""Based on the following content, generate {num_questions} high-quality multiple-choice questions.
...
- Return ONLY valid JSON, no other text"""
        ...
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are an expert educator creating multiple-choice questions. Always respond with valid JSON only."},
                {"role": "user", "content": prompt}
            ],
            temperature=0.7,
            max_tokens=min(4000, num_questions * 300)
        )
        ...
        try:
            ...
            print("JSON parse error, falling back to simple generation")
            return generate_simple_mcqs(text, num_questions)
...
def generate_simple_mcqs(text, num_questions=10):
    ...
    questions = []
    num_questions = min(num_questions, len(sentences), 50)  # Increased limit
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* NEW: Enhanced Question Counter Styles */
        ...
        #numQuestions::-webkit-slider-thumb {
            appearance: none;
            width: 25px;
            height: 25px;
            border-radius: 50%;
...
<body>
    <div id="mainContainer">
        ...
        <p class="subtitle">Upload documents and get intelligent quiz questions</p>
        ...
        <div id="uploadScreen">
            <div class="info-box">
                ...
                <ul style="margin-left: 20px; margin-top: 10px;">
                    ...
                    <li>Choose how many questions you want (5-50)</li>
            ...
            <div class="question-counter-container">
                ...
                <div class="question-counter-controls">
                    <div class="slider-container">
                        <input type="range" id="numQuestions" min="5" max="50" value="10" step="1">
                        <div class="question-range-label">5 ← Slide → 50</div>
                    </div>
                    
                    <div class="number-input-container">
                        <input type="number" id="numQuestionsInput" min="5" max="50" value="10">
                        <span style="font-size: 1.2em; color: #1e3c72; font-weight: bold;">Questions</span>
                    </div>
                </div>
                
                <div class="quick-select">
                    <button class="quick-select-btn" onclick="setQuestionCount(5)">5</button>
                    <button class="quick-select-btn" onclick="setQuestionCount(10)">10</button>
                    <button class="quick-select-btn" onclick="setQuestionCount(15)">15</button>
                    <button class="quick-select-btn" onclick="setQuestionCount(20)">20</button>
                    <button class="quick-select-btn" onclick="setQuestionCount(30)">30</button>
        ...
        <div id="loadingScreen">
            ...
            <div style="text-align: center; color: #1e3c72; font-size: 1.2em; margin: 20px;">
                ...
                <span style="font-size: 0.9em; color: #666;">Generating <span id="loadingNumQuestions">10</span> questions - This may take 10-60 seconds</span>
            </div>
        </div>
    ...
    <script>
        ...
        // NEW: Synchronized question counter controls
        ...
        document.getElementById('uploadBtn').onclick = async function() {
            ...
            const numQuestions = document.getElementById('numQuestionsInput').value;
            formData.append('num_questions', numQuestions);
            
            document.getElementById('loadingNumQuestions').textContent = numQuestions;
        ...
        function checkAnswer(selected) {
            ...
            if (isCorrect) {
                ...
                document.getElementById('feedbackText').textContent = '❌ Incorrect. The correct answer is ' + String.fromCharCode(65 + q.correct_index);
...
def upload_file():
    ...
    try:
        ...
        num_questions = max(5, min(50, num_questions))  # Ensure it's between 5 and 50
