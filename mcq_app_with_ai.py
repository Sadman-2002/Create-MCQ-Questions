...
<body>
    <div id="mainContainer">
        ...
        <div id="uploadScreen">
            ...
            <div class="center">
                <label style="font-size: 1.1em;">Number of Questions: <span id="numValue" style="font-weight: bold; color: #1e3c72;">10</span></label><br>
        ...
        <div id="loadingScreen">
            ...
            <div style="text-align: center; color: #1e3c72; font-size: 1.2em; margin: 20px;">
                ...
                <span style="font-size: 0.9em; color: #666;">This may take 10-30 seconds</span>
            </div>
        </div>
