...
- Return ONLY valid JSON, no other text"""
            ...
            response = client.chat.completions.create(
                ...
                temperature=0.7,
                max_tokens=min(4000, questions_in_batch * 350)
            )
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Enhanced Question Counter Styles - UNLIMITED */
...
<body>
        ...
        <div id="loadingScreen">
            ...
            <div style="text-align: center; color: #1e3c72; font-size: 1.2em; margin: 20px;">
                ...
                <span style="font-size: 0.9em; color: #666;">
                    This may take <span id="estimatedTime">10-30</span> seconds
                </span>
            </div>
        </div>
    ...
    <script>
        ...
        // Validate input (minimum 1, no maximum)
        input.oninput = function() {
            let value = parseInt(this.value);
            if (isNaN(value) || value < 1) {
                this.value = 1;
            }
            // Remove any maximum limit - allow any positive number
        };
        ...
        document.getElementById('uploadBtn').onclick = async function() {
            ...
            // Estimate time based on number of questions
...
def upload_file():
    ...
    try:
        ...
        # Validate minimum only (no maximum limit)
        if num_questions < 1:
